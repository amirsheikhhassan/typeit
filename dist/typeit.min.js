  ...
  */
  ...
  var getAllTypeableNodes = function getAllTypeableNodes(element, parentToExclude, shouldReverse) {
    ...
    if (parentToExclude) {
      nodes = nodes.filter(function (n) {
        return !n.parentNode.isEqualNode(parentToExclude);
      });
    }
  ...
  var constructQueueFromNodes = function constructQueueFromNodes(el) {
    ...
    var characterObjects = nodeList.map(function (item) {
      ...
      return toArray(item.nodeValue).map(function (character) {
  ...
  var randomInRange = (function (value, range) {
  ...
  function TypeIt(element, options) {
    ...
    var _disableCursorBlink = function _disableCursorBlink(shouldDisable) {
      if (!_cursor) {
        return;
      }
    ...
    var _loopify = _async(function (delay) {
      ...
      return _invoke(function () {
        ...
        _getAllChars().forEach(function (i) {
    ...
    var _fire = _async(function () {
      ...
      return _continue(_catch(function () {
        return _continue(_forTo(queueItems, function (i) {
          ...
          callbackArgs = [queueAction, _this2];
          ...
          return _invoke(function () {
            ...
            return _await((_opts3 = _opts).beforeStep.apply(_opts3, callbackArgs), function () {
              ...
              return _await(queueAction[0].call(_this2, queueAction[1], queueActionMeta), function () {
    ...
    this.delete = function (numCharacters, actionOpts) {
      ...
      return _queueAndReturn([bookEndQueueItems[0]].concat([].concat(Array(Math.abs(numCharacters) || 1)).fill().map(function () {
    ...
    this.move = function (movementArg, actionOpts) {
      ...
      return _queueAndReturn([bookEndQueueItems[0]].concat([].concat(Array(Math.abs(movementArg) || 1)).fill().map(function () {
